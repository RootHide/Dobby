...
class DarwinPlatformBuilder(PlatformBuilder):
  ...
  def __init__(self, project_dir, library_build_type, platform, arch):
    ...
    if platform == "macos":
      ...
      self.cmake_args += ["-DCMAKE_SYSTEM_NAME=iOS", "-DCMAKE_OSX_DEPLOYMENT_TARGET=9.3", "-DCMAKE_OSX_SYSROOT=/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS.sdk"]
